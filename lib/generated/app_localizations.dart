...
abstract class AppLocalizations {
  ...
  /// No description provided for @roadIssues.
  ///
  /// In en, this message translates to:
  /// **'Road Issues'**
  String get roadIssues;
  ...
  /// No description provided for @startByFilingFirstComplaint.
  ///
  /// In en, this message translates to:
  /// **'Start by filing your first complaint to help improve your community'**
  String get startByFilingFirstComplaint;

  /// No description provided for @fileYourFirstComplaint.
  ///
  /// In en, this message translates to:
  /// **'File Your First Complaint'**
  String get fileYourFirstComplaint;

  /// No description provided for @complaintFiledSuccessfully.
  ///
  /// In en, this message translates to:
  /// **'Complaint filed successfully!'**
  String get complaintFiledSuccessfully;

  /// No description provided for @failedToFileComplaint.
  ///
  /// In en, this message translates to:
  /// **'Failed to file complaint'**
  String get failedToFileComplaint;
  ...
  /// No description provided for @noComplaintsDesc.
  ///
  /// In en, this message translates to:
  /// **'Start by filing your first complaint to help improve your community'**
  String get noComplaintsDesc;

  /// No description provided for @fileFirstComplaint.
  ///
  /// In en, this message translates to:
  /// **'File Your First Complaint'**
  String get fileFirstComplaint;
  ...
  /// No description provided for @attachedPhoto.
  ///
  /// In en, this message translates to:
  /// **'Attached Photo'**
  String get attachedPhoto;
  ...
  /// No description provided for @filedBy.
  ///
  /// In en, this message translates to:
  /// **'Filed by'**
  String get filedBy;
  ...
  /// No description provided for @deleteComplaintConfirmation.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete this complaint? This action cannot be undone.'**
  String get deleteComplaintConfirmation;

  /// No description provided for @complaintDeletedSuccess.
  ///
  /// In en, this message translates to:
